...
function Card({name, link, likes, onCardClick}) {
    ...
    return (
    <li class="list__card">
        <button class="list__remove" type="button"></button>
        <button class="list__button-image" type="button" onClick={handleCardClick}><img class="list__image" src={link} alt="."/></button>
